          ...
          {id === 6 &&(
            ...
            <div className={cn(
             titleClassName , 'group-hover/bento:translate-x-2 transition duration-200 relative md: h-full min-h-40 flex flex-col px-5 p-5 lg:p-10'
                ...
                <div className="font-light font-size-0 text-white  text-sm md:text-sm lg:text-sm z-10 mb-5">
                 {description} 
                </div>
                <div className="font-sans font-bold text-lg lg:text-3xl max-w-96 z-10 mb-1">
                  {title}
                </div>
