  ...
  export const gridItems = [
    {
      ...
      className: "lg:col-span-2  md:col-span-3 md:row-span-2 lg:min-h-[60vh] text-purple font-helvatica",
  ...
  export const workExperience = [
    {
      ...
      desc: "We develop web-based platform using React.js,Django, enhancing interactivity and empowering your brand with dynamic and engaging digital experiences .",
    ...
    },
    {
      ...
      desc: "We help your brand thrive in the digital realm, connecting you with your target audience.",
    ...
    },
    {
      id: 3,
      title: "Graphic Design",
      desc: "Our designers specialize in crafting unique and memorable brand identities that reflect your values.",
      className: "md:col-span-2", // change to md:col-span-2
      thumbnail: "/i1.jpg",
    ...
    {
      id: 4,
      title: "Software and Mobile App development",
      desc: "Designed and developed mobile app for both iOS & Android platforms using React Native.Develop and maintain effective softwares which are user friendly. Led the dev of a mobile app for a client, from initial concept to deployment on app stores",
      className: "md:col-span-2",
      thumbnail: "/exp4.svg",
    },
  ];
